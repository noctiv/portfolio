      ...
      <div>
        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-12">
                ...
                <div className="col-md-12">
                    ...
                    <p>I am a computer grad student from SRMIST Chennai.I love exploring new technologies and often amazed by the progress we as a human species have made so far in the recent years.</p>
                    <p>I have started reflecting my ideas and thougths through the medium of words recently so spelling and grammer mistaks are very often.You can write me back if you spot any and don't want me to live anymore :P </p>
                    </div>
                </div>
                </div>
            </div>
        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    <h3>UI/UX</h3>
                    <p>Yeah! I do a little bit of designing.</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
